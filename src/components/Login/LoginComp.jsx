      ...
      <LoginForm>
        ...
        <Form>
          <LeftSection>
            ...
            <SignUp onClick={onOpen}>Sign up with Email</SignUp>
            <Modal
        ...
        <Footer>
          ...
          <About>
            <p>
              ...
              <span>Terms</span>・<span>Contact</span>・<span>Languages</span>・
              <span>Your Ad Choices</span>・<span>Press</span>・© Quora, Inc.
              2021
            </p>
          </About>
        </Footer>
...
const Container = styled.div`
  width: 100%;
  min-height: 100vh;
  background: url('//qsf.fs.quoracdn.net/-4-ans_frontend_assets.images.home_page_bg_desktop.png-26-4770753d59b970e1.png');
