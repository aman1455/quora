  ...
  return (
    <>
      ...
      <Card border={"1px solid rgb(222,224,225)"} w="50%"  pl={"10px"}>
        <Text  fontWeight={"bold"} fontSize={"25px"}>{data.question}</Text>
                      ...
                      >
                        ...
                        <ModalContent >
                         ...
                         <Img borderRadius={30} h={"50px"} w={"50px"} src={userReducer.avatar}/>
                          ...
                          <ModalBody pb={6}>
                            <FormControl>
                              <FormLabel fontWeight={"bold"} fontSize="20px">{data.question}</FormLabel>
                              <Textarea
                                ref={initialRef}
        ...
        <Flex flexDirection={"column"}>
             ...
             <Center><Img mt={"20px"} borderRadius={"20px"} border="1px solid" borderColor={"rgb(210,202,187)"} w={"5%"} src={userReducer.avatar}/></Center>  
             <Center fontWeight={"500"}> <Text >{userReducer.name} <Text as={"span"}>, can you answer this question?</Text></Text></Center> 
             <Center> <Text color={"rgb(147,149,152)"}  fontSize={"15px"}>People are searching for a better answer to this question.</Text></Center> 
             <Center> 
             <Button
                        colorScheme="blackAlpha"
                        variant="outline"
                      ...
                      >
                      <Icon  boxSize={6}>
                      <g stroke-width="1.5" fill="none" fill-rule="evenodd"><path d="M18.571 5.429h0a2 2 0 0 1 0 2.828l-9.9 9.9-4.24 1.416 1.412-4.245 9.9-9.9h0a2 2 0 0 1 2.828 0Z" class="icon_svg-stroke" stroke="rgb(46,105,255)" stroke-linecap="round" stroke-linejoin="round"></path><path class="icon_svg-fill_as_stroke" fill="#666" d="m4.429 19.571 2.652-.884-1.768-1.768z"></path><path d="M14.5 19.5h5v-5m-10-10h-5v5" class="icon_svg-stroke" stroke="rgb(46,105,255)" stroke-linecap="round" stroke-linejoin="round"></path></g>
                      </Icon>
                        Edit draft
                      </Button>
                      <Modal
